				...
				<div class="card">
					<div class="card-body">
						<div class="card-title">
							<h3 class="text-center title-2">Modification Enseignents</h3>
						</div>
						<hr>
					...
					<?php if(count($liste_fonctions) == 0  || count($listematiere) == 0){?>
						...
						<?php 
							...
							{
						?>
						<form action="<?php echo base_url('EnseignantsControllers/Modification')?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        <?php foreach($professeur as $key): ?>
                            ...
                            <input type="hidden" class="form-control" name="professeur_id" id="professeur_id"  value="<?= $key->professeur_id; ?>">
