	...
	<div class="section__content section__content--p30">
		<div class="container-fluid">
			...
			<?php 
				foreach($classeListe as $Liste){
					...
					if(count($classeListe) == 1){?>
						...
						<a href="<?= base_url('ParametreControllers/classeSelect/').$Liste->classe_id ?>" class="col-sm-6 col-lg-10">
			...
			<?php 
				...
				<a href="<?= base_url('ParametreControllers/classeSelect/').$Liste->classe_id ?>" class="col-sm-6 col-lg-5">
						<div class="overview-item overview-item--c1">
							<div class="overview__inner">
								<div class="overview-box clearfix">
									<div class="icon">
				...
				elseif(count($classeListe) >= 3){?>
					<a href="<?= base_url('ParametreControllers/classeSelect/').$Liste->classe_id ?>" class="col-sm-6 col-lg-3">
						<div class="overview-item overview-item--c1">
							<div class="overview__inner">
								<div class="overview-box clearfix">
									<div class="icon">
